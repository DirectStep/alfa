      ...
      <Container>
        ...
        <div className="mt-10 grid gap-5 laptop:grid-cols-[0.78fr_1.22fr]">
          ...
          <div className="divide-y divide-black/20 border-y border-black/20">
            {formats.map((item) => (
              <a key={item.title} href={assetPath("/ai-agent")} className="group grid min-h-[128px] grid-cols-[38px_1fr_auto] items-center gap-4 py-5 sm:grid-cols-[46px_1fr_auto] sm:gap-6">
